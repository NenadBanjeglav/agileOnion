...
const POST_COVERS: Record<string, string> = {
  'cynefin-framework-na-poslu': '/media/trail/trail-standup.webp',
  'zasto-je-planiranje-vazno-za-scrum-tim': '/media/trail/trail-kanban.webp',
  'product-owner-vs-scrum-master': '/media/trail/trail-collab.webp',
  'pet-nacina-za-growth-mindset': '/media/trail/trail-notebook.webp',
}

type CarouselPost = BlogPost & { image: string }

const posts: CarouselPost[] = blogPosts.map((post) => ({
  ...post,
  image: POST_COVERS[post.slug] ?? '/media/trail/trail-notes.webp',
}))
