  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden
      >
        <div className="absolute inset-x-0 top-10 mx-auto h-60 w-11/12 rounded-full bg-[#01DCA0]/16 blur-[110px]" />
        <div
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 sm:gap-10">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-3">
            <span className="inline-flex w-fit items-center gap-2 rounded-full border border-[#00B3D5]/30 bg-[#00B3D5]/10 px-4 py-2 text-[11px] font-semibold tracking-[0.14em] text-[#d9fbff] uppercase">
              Novo na blogu
            </span>
...
function BlogCard({
  ...
  return (
    ...
    >
      <motion.article
        className="relative flex h-full min-h-[360px] flex-col overflow-hidden rounded-3xl border border-white/10 bg-zinc-900/60 p-4 shadow-[0_24px_70px_-36px_rgba(0,0,0,0.9)] ring-1 ring-white/5 transition duration-200 group-hover:border-[#00B3D5]/50 group-hover:ring-[#00B3D5]/40"
      ...
      >
        <div className="relative h-40 overflow-hidden rounded-2xl">
          ...
          <span className="absolute top-3 left-3 inline-flex items-center rounded-full border border-[#00B3D5]/60 bg-[#00B3D5]/15 px-3 py-1 text-[10px] font-semibold tracking-[0.12em] text-[#e6f9ff] uppercase shadow-inner shadow-black/20">
            {primaryTag}
          </span>
        </div>
...
function CarouselButton({
  ...
  return (
    <button
      ...
      disabled={disabled}
      aria-label={label}
      className={`cursor-pointer rounded-full border border-white/20 bg-white/10 p-2 text-white transition duration-200 hover:border-[#00B3D5]/60 hover:bg-[#00B3D5]/10 focus-visible:ring-2 focus-visible:ring-[#00B3D5] focus-visible:ring-offset-2 focus-visible:ring-offset-black focus-visible:outline-none ${
        disabled ? 'opacity-40' : ''
      }`}
    >
